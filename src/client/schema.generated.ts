...
export interface PageToTermNodeConnectionWhereArgs {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars["String"]>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars["Int"]>;
...
export const generatedSchema = {
  ...
  LanguageInfo: {
    __typename: { __type: "String!" },
    code: { __type: "String" },
    default_locale: { __type: "String" },
    id: { __type: "ID!" },
    is_hidden: { __type: "Boolean" },
    native_name: { __type: "String" },
    translated_name: { __type: "String" },
  },
  Locale: {
    __typename: { __type: "String!" },
    id: { __type: "ID!" },
  ...
  MediaItem: {
    ...
    localizedWpmlUrl: { __type: "String" },
    ...
    translated: { __type: "[MediaItem]" },
    translations: { __type: "[Translation]" },
    uri: { __type: "String" },
  },
  MediaItemMeta: {
    __typename: { __type: "String!" },
  ...
  Page: {
    ...
    templates: { __type: "[String]" },
    terms: {
      __type: "PageToTermNodeConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
  ...
  PageToTermNodeConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[PageToTermNodeConnectionEdge]" },
    nodes: { __type: "[TermNode]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  ...
  PageToTermNodeConnectionWhereArgs: {
    cacheDomain: { __type: "String" },
    childOf: { __type: "Int" },
    childless: { __type: "Boolean" },
    descriptionLike: { __type: "String" },
  ...
  Page_Homepage: {
    ...
    heroImage: { __type: "MediaItem" },
    introExcerpt: { __type: "String" },
  },
  Plugin: {
    __typename: { __type: "String!" },
    author: { __type: "String" },
  ...
  query: {
    ...
    discussionSettings: { __type: "DiscussionSettings" },
    generalSettings: { __type: "GeneralSettings" },
    languages: { __type: "[LanguageInfo]" },
    locales: { __type: "[String]" },
    mediaItem: {
      __type: "MediaItem",
...
export interface LanguageInfo {
   ...
   */
  default_locale?: Maybe<ScalarsEnums["String"]>;
  /**
   * Language ID (WPML)
   */
  id: ScalarsEnums["ID"];
   ...
   */
  native_name?: Maybe<ScalarsEnums["String"]>;
  /**
   * Language translated name (WPML)
   */
  translated_name?: Maybe<ScalarsEnums["String"]>;
}
...
export interface MediaItem {
   ...
   */
  localizedWpmlUrl?: Maybe<ScalarsEnums["String"]>;
  /**
...
export interface Page {
  ...
  }) => Maybe<PageToTermNodeConnection>;
  /**
   * The title of the post. This is currently just the raw title. An amendment to support rendered title needs to be made.
   */
  title: (args?: {
 ...
 * Connection between the page type and the TermNode type
 */
export interface PageToTermNodeConnection {
 ...
 * An edge in a connection
 */
export interface PageToTermNodeConnectionEdge {
 ...
 * Field Group
 */
export interface Page_Homepage {
  __typename?: "Page_Homepage";
  /**
   * The name of the ACF Field Group
   */
  ...
  introExcerpt?: Maybe<ScalarsEnums["String"]>;
}
...
export interface Translation {
   ...
   */
  post_title?: Maybe<ScalarsEnums["String"]>;
}
...
export interface Query {
  ...
  locales?: Maybe<Array<Maybe<ScalarsEnums["String"]>>>;
  mediaItem: (args: {
    asPreview?: Maybe<Scalars["Boolean"]>;
    id: Scalars["ID"];
...
export interface SchemaObjectTypes {
  ...
  PageToTermNodeConnection: PageToTermNodeConnection;
  PageToTermNodeConnectionEdge: PageToTermNodeConnectionEdge;
